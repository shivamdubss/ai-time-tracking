...
export function SummaryStats({ totalHours, totalBillableMinutes, totalBillableValue, totalNonBillableMinutes }: SummaryStatsProps) {
  return (
    <div className="grid grid-cols-3 gap-3">
      ...
      <div className="bg-surface border border-border rounded-[var(--radius-sm)] px-4 py-3">
        ...
        {totalBillableValue > 0 && (
          <div className="font-mono tabular-nums text-xs text-text-muted mt-0.5">
